        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-24">
            <p className="text-sm md:text-lg lg:text-2xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light">
              Contact Us. <br /> Any questions, We&apos;re here.
            </p>
          </div>
            ...
            <div className="space-y-12">
              <div className="space-y-8">
                <div className="flex items-start space-x-4 md:space-x-6">
                  ...
                  <div>
                    <h3 className="md:text-2xl font-bold text-slate-900 mb-1 md:mb-3 tracking-tight">
                      Quick Booking
                    </h3>
                    ...
                    <div className="pt-3">
                      <div>
                        <h3 className="md:text-lg font-bold text-slate-900 tracking-tight">
                          Contact Number
                        </h3>
                ...
                <div className="flex items-start space-x-4 md:space-x-6">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 leading-relaxed text-xs md:text-lg">
                      ...
                      security measures, ensuring complete privacy and
                      compliance.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 md:space-x-6">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 leading-relaxed text-xs md:text-lg">
                      Access expert medical advice anytime, anywhere with our
