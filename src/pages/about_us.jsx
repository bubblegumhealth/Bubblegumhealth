            ...
            <div className="w-full">
              <div className="max-w-3xl text-white space-y-3 p-4">
                ...
                <div className="text-lg">
                  We believe sexual wellness should be as normal as buying
                  vitamins. So we created a space where you can shop with
                  confidence, learn without judgment, and prioritize your health
                  without any weird vibes.
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto space-y-10 p-4">
          <div className="space-y-8">
            ...
            <div className="text-xl">
              Bubblegum Health is a FemTech platform dedicated to improving
              women&apos;s reproductive healthcare. From confidential consultations
              with licensed female doctors to trusted health products, we make
              expert care accessible, private, and stigma-free.
            </div>
