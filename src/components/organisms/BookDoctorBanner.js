...
export function BookDoctorBanner() {
    ...
    return (
        <>
            <AppointmentForm setshowWaitModal={setshowWaitModal} showWaitModal={showWaitModal} />
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-12">
                            ...
                            <div className="flex flex-row gap-4">
                                <div onClick={() => setshowWaitModal(true)} className="bg-bub-primary/90 cursor-pointer flex rounded-md hover:bg-bub-primary text-white px-8 py-3">
